        ...
        Show.Controller = Application.Controllers.Base.extend({
            ...
            getUserDropDownOptions: function() {
                return new Application.Entities.Collection([
                    new Application.Entities.Model({optionId:"profile", optionUrl: "#user/profile", optionText: "Profile", iconClass: "icon-user"}),
                    new Application.Entities.Model({optionId:"logout", optionUrl: Application.LOGOUT, optionText: "Logout", iconClass: "icon-off"})
                ])
            },
            ...
            getAdminDropDownOptions: function() {
                return new Application.Entities.Collection([
                    new Application.Entities.Model({optionId:"profile", optionUrl: "#user/profile", optionText: "Profile", iconClass: "icon-user"}),
                    new Application.Entities.Model({optionId:"admin", optionUrl: "#admin", optionText: "Admin", iconClass: ""}),
                    new Application.Entities.Model({optionId:"logout", optionUrl: Application.LOGOUT, optionText: "Logout", iconClass: "icon-off"})
                ])
            }
        })
