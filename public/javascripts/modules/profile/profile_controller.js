        ...
        Profile.Controller = Application.Controllers.Base.extend({
            initialize: function() {
                ...
                this.listenTo(this.layout, Application.SHOW, function(){
                    this.populateView(user, allSchools, allCounselors, allStreams, allOccupations);
                });

                this.show(this.layout, {
                    loading: {
                        entities: [user, allSchools, allCounselors, allStreams, allOccupations]
                    }
                });
            },

            populateView: function(user, allSchools, allCounselors, allStreams, allOccupations) {
